...
HD_PWD='D:/Xilinx_projects/USC_Keypad/Keypad_5RO_6WO_ports/synthesis/ee354_lab7_part2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodKYPD_5RO_6WO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodKYPD_5RO_6WO.tcl -notrace
